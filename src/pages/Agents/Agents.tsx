          ...
          <Orbit size="50" speed="1.5" color="blue" />
            ...
            <div className="space-y-6">
                {filteredSites.map(([siteName, agents]) => {
                    // Trouver le responsable du site (on prend le premier agent comme référence)
                    const siteResponsable = agents[0]?.responsable || 'Non spécifié';

                    return (

                        <div key={siteName} className="bg-white rounded-2xl shadow-md overflow-hidden ">
                            <div className="bg-blue-100 px-6 py-4 flex flex-col">
                                ...
                                <p className="text-sm text-gray-600 mt-1">
                                    <strong>Responsable :</strong> {siteResponsable}
                                </p>
                            </div>
                                ...
                                <table className="table table-zebra w-full">
                                    ...
                                    <tbody>
                                        {agents.map((agent) => (
                                            ...
                                            <tr onClick={() => handleViewDetails(agent)} key={agent.id} className="hover:bg-gray-50">
